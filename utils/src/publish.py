...
if __name__ == '__main__':
    ...
    #     urllib.request.urlretrieve('https://raw.githubusercontent.com/Loyalsoldier/geoip/release/Country.mmdb', './Country.mmdb')
    #     print('Success!\n')
    # except Exception:
    #     print('Failed!\n')
    #     pass
    ...
    if configparse('common').getboolean('speedtest_enabled'):
        ...
        os.system(f'proxychains python3 ./utils/src/litespeedtest/speedtest.py --subscription \"../../{subscription}\" --range \"{range}\" --path \"../../temp\"')
        ...
        for area in area_proxies.keys():
            ...
            os.system(f'proxychains python3 ./utils/src/litespeedtest/speedtest.py --subscription \"../../temp\" --range \"{area_proxies[area][1]}\" --path \"../../temp\"')
        ...
        os.system(f'python3 ./utils/src/subconverter/subconvert.py --subscription \"../../temp\" --target \"base64\" --output \"../../{share_file}\"')
        os.system(f'python3 ./utils/src/subconverter/subconvert.py --subscription \"../../temp\" --target \"clash\" --output \"../../{share_file_clash}\"')
        os.remove('./temp')